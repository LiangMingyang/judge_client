...
(function() {
  var FILE_PAGE, Promise, REPORT_PAGE, TASK_PAGE, URL, child_process, crypto, data_root, fs, judge_client, log, path, resource_dir, rp, test_script_path;
  ...
  judge_client = (function() {
    ...
    judge_client.prototype.start = function() {
      ...
      return promiseWhile(self.work).then(function() {
        ...
        return process.disconnect && process.disconnect();
      })["catch"](function(err) {
        return console.log(err);
      });
    };
